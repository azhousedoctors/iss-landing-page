...
faqData = [
    {"q": "Aren’t you my competitor?", "a": "We’re licensed inspectors, yes. That’s the point. It’s why we know what your report needs and what your agent expects by Friday. We chose the ancillary side seven years ago, and that’s what ISS is. The partner agreement carries a written non-solicit from us to you: we do not market to, contact, or accept general inspection work from any client or agent we meet on your job. If one of them calls us anyway, we send them back to you. Nobody’s cards, signs, or shirts on your jobs but yours. Break that and you can terminate the same day. Our business only works if yours grows."},
